...
% drawEpipolarLines('im1corrected.jpg', 'im2corrected.jpg', F, savx1, savx2, savy1, savy2);
...
fundamental_matrix = eightPointAlgorithm('im1corrected.jpg', 'im2corrected.jpg', savx1, savx2, savy1, savy2);

%SED = computeSED(fundamental_matrix, p1_projection, p2_projection);
